namespace HomeworkNo1.Models
{
	public static class RepositoryHelper
	{
		...
		public static View簡易報表Repository GetView簡易報表Repository()
		{
			var repository = new View簡易報表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View簡易報表Repository GetView簡易報表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new View簡易報表Repository();
